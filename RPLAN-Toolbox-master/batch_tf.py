...
if __name__ == '__main__':
    ...
    for i in tqdm(ids):
        name, tf_piecewise_i, tf_discrete_i = func(i)
        tf_piecewise[name] = tf_piecewise_i
        tf_discrete[name] = tf_discrete_i

    savepkl('./output/tf_piecewise.pkl', tf_piecewise)
    savepkl('./output/tf_discrete.pkl', tf_discrete)
    # for matlab
    # savemat('./output/data.mat', {'tf_piecewise': tf_piecewise, 'tf_discrete': tf_discrete})